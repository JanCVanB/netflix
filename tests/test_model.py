...
def test_model_save_creates_file_at_expected_file_path():
    import os.path
    from utils.data_paths import ROOT_DIR_PATH
    model = Model()
    model_file_name = 'test'
    model_file_path = os.path.join(ROOT_DIR_PATH, model_file_name)
...
def test_model_load_returns_none():
    ...
    model = Model()
    model_file_name = 'test'
    model_file_path = join(ROOT_DIR_PATH, model_file_name)
